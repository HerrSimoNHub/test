...
_G.Tip1 = "ez" --// Gives You Tips On The UI
_G.Tip2 = "ez" --// Gives You Tips On The UI
_G.Tip3 = "ez" --// Gives You Tips On The UI
_G.Tip4 = "ez" --// Gives You Tips On The UI
_G.Tip5 = "ez" --// Gives You Tips On The UI

loadstring(game:HttpGet("https://raw.githubusercontent.com/HerrSimoNHub/api/main/test.lua"))()
